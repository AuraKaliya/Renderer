...
private:
    ...
    public:
        ...
        void setBoxCornerStart(const renderer::scene_contract::Vec3f& cornerStart);
        void setBoxCornerEnd(const renderer::scene_contract::Vec3f& cornerEnd);
        ...
        void setCylinderAxisStart(const renderer::scene_contract::Vec3f& axisStart);
        void setCylinderAxisEnd(const renderer::scene_contract::Vec3f& axisEnd);
        ...
        void setSphereDiameterStart(const renderer::scene_contract::Vec3f& diameterStart);
        void setSphereDiameterEnd(const renderer::scene_contract::Vec3f& diameterEnd);
